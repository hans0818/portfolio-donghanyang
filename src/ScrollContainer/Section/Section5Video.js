    ...
    <div className={styles.section5VideoWrapper} ref={sectionRef}>
      ...
      <div className={styles.textGrid}>
        <div className={styles.textSection1}>
          <p>
            보험설계사로 근무하면서 많은 분들이 모바일 청약의 불편함을 보았습니다. 
            모바일 청약은 편리한 면도 있지만 UI는 저도 불편합니다.
            특히, 나이드신 분들은 모바일 청약을 못하는 걸 보면서 모바일 청약의 불필요한 요소가 
            사용자에게 얼마나 불편함을 느끼게 하는지 깨달았습니다. 
            이 경험은 통해 단순히 기능을 제공하는 것이 아니라, <span className={styles.highlight}>모든 사용자가 쉽게 사용할 수 있도록 
            설계</span>되어야 한다는 것을 느꼈습니다.
            프로젝트를 진행하면서 <span className={styles.highlight}>누구나 쉽게 접근할 수 있는 UI설계</span>를 끊임없이 고만하고 있습니다.
          </p>
        </div>

        <div className={styles.textSection2}>
          <p>
            제 UI에서 중요한 핵심은 <span className={styles.highlight}>효율적인 압축</span> 입니다.<br /><br />
            첫번째로 <span className={styles.highlight}>단순함이 주는 편리함</span> 입니다. 
            하나의 화면에 너무 많은 것을 담는 것을 피했습니다.<br /><br />
            두번째는 <span className={styles.highlight}>경험으로 UI를 익히는 것</span>입니다. 
            미적인 요소로 애니메이션을 넣는 것이 아니라 
            경험으로 사용법을 습득할 수 있게 애니메이션을 구성했습니다.<br /><br />
            세번째는 <span className={styles.highlight}>본질에 집중</span> 하는 것입니다. 
            좋은 자동차는 옵션이 많은 자동차가 아니라 
            엑셀과 브레이크 같이 핵심적인 성능이 좋아야 명차라고 생각합니다. 
            ESLint와 테스트 코드 작성, 수많은 리펙토링으로 본질 기능이 제대로 구현 되도록 작성했습니다.
          </p>
        </div>
      </div>
    </div>
